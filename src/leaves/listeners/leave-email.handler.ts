...
export class LeaveEmailHandler {
  ...
  // ── Leave modified (by HR) → notify Employee ──────────────────────────────
  ...
  async handleLeaveModified(event: LeaveModifiedEvent) {
    ...
    const isNowApproved =
      event.newStatus === LeaveStatus.APPROVED || event.newStatus === 'MODIFIED';
    ...
    // Build diff rows – highlight changed fields
    ...
    const body = `
      <p style="margin:0 0 20px;font-size:14px;color:#334155;line-height:1.6;">
        Your leave request has been <strong style="color:${accentColor};">modified by HR</strong>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e2e8f0;border-radius:8px;overflow:hidden;">
        ...
        <tr>
          ...
          <td style="padding:10px 20px;border-bottom:1px solid #f1f5f9;background:#f8fafc;">
            <span style="font-size:13px;">${changeHighlight(typeChanged, newTypeLabel)}</span>
          </td>
        </tr>
        <tr>
          ...
          <td style="padding:10px 20px;border-bottom:1px solid #f1f5f9;">
            <span style="font-size:13px;">${changeHighlight(datesChanged, newDateRange)}</span>
          </td>
        </tr>
        <tr>
          <td style="padding:10px 20px;border-bottom:1px solid #f1f5f9;background:#f8fafc;">
          ...
          <td style="padding:10px 20px;border-bottom:1px solid #f1f5f9;background:#f8fafc;">
            <span style="font-size:13px;">${changeHighlight(daysChanged, newDays)}</span>
          </td>
        </tr>
        ${
          statusChanged
          ...
          <td style="padding:10px 20px;border-bottom:1px solid #f1f5f9;">
            <span style="font-size:13px;">${changeHighlight(true, statusLabel)}</span>
          </td>
        </tr>`
            : ''
        }
