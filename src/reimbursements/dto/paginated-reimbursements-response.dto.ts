...
class ReimbursementReceiptDto {
  ...
  @ApiProperty({ required: false, type: Number }) amount!: number | null;
  @ApiProperty() isManuallyEdited!: boolean;
...
class ReimbursementRequestDto {
  ...
  @ApiProperty({ type: [ReimbursementReceiptDto] }) receipts!: ReimbursementReceiptDto[];
